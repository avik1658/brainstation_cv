...
interface DropdownProps<T extends React.ReactNode & React.Key> {
    label: string;
    options: T[];
    selected: T;
...
function Dropdown<T extends React.ReactNode & React.Key>({ label, options, selected, setSelected }: DropdownProps<T>) {
    return (
            ...
            <div className="flex gap-4">
                ...
                <DropdownMenu>
                    ...
                    <DropdownMenuContent className="bg-white shadow-lg rounded-lg mt-2 w-48 text-gray-800">
                        <DropdownMenuItem className="hover:bg-gray-100 px-4 py-2">DownLoad 3:2</DropdownMenuItem>
                        <DropdownMenuItem className="hover:bg-gray-100 px-4 py-2">DownLoad 2:3</DropdownMenuItem>
                        <DropdownMenuItem className="hover:bg-gray-100 px-4 py-2" onClick={(e) => e.preventDefault()}>
                            <Dialog>
